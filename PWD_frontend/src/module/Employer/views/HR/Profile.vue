      ...
      <div class="left-panel">
        <div class="avatar-card">
          <div class="avatar-image">
            <img v-if="profile.photoURL" :src="profile.photoURL" alt="Profile" class="avatar-photo" />
          ...
          <div v-if="isEditing" class="modal-backdrop" @click.self="toggleEdit">
            <div class="modal">
              ...
              <div class="modal-avatar">
                <img v-if="profile.photoURL" :src="profile.photoURL" alt="Profile" class="modal-photo" />
              ...
              <div class="modal-body">
                <div class="photo-row">
                  <div class="photo-preview">
                    <img v-if="form.photoURL" :src="form.photoURL" alt="Preview" />
