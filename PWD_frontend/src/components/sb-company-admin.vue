<template>
  ...
  >
    ...
    <nav class="nav">
      ...
      <router-link
        to="/company-admin/add-employee"
        class="nav-link"
        :class="{ active: route.path.includes('/company-admin/add-employee') }"
      ...
      >
        ...
        <span v-if="collapsed && tooltip === 'Add Employee'" class="tooltip">Add Employee</span>
      </router-link>
    </nav>
